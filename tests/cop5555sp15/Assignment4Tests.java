...
public class Assignment4Tests {
	...
	*  true
	...
	public void stringVariable() throws Exception{
		...
		String input = "class A {def x: string; \n x = \"almost done\";\n  print x;\n}";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		assertNotNull(program);
		typeCheckCorrectAST(program);
...
//	@Test
	 ...
	 * It is legal to declare a variable with the same name in different scopes
	 * @throws Exception
	 *
	 * outputs:
	 * 6
	 * 3
	 */
	public void varScopeDec() throws Exception{
		System.out.println("***********varScopeDec");
		String input = "class A {\n def x:int; \n x = 3;\n {\n  def x:int;\n  x = 6;\n  print x;\n }\n print x;\n}";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		assertNotNull(program);
	 ...
	 * @throws Exception
	 */
	public void undeclaredVarFail1() throws Exception {
		System.out.println("***********undeclaredVarFail1");
		String input = "class A {\n print x;\n}";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		typeCheckIncorrectAST(program);
...
//	@Test
	 ...
	 * @throws Exception
	 */
	public void undeclaredVarFail2() throws Exception {
		System.out.println("***********undeclaredVarFail2");
		String input = "class A {\n def x:int;\n x = y;\n print x;\n}";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		typeCheckIncorrectAST(program);
...
//	@Test
	/**
	 * TODO: Get test to work
	 * A test that should fail due to the use of a variable that is out of scope
	 * @throws Exception
	 */
	public void scopeFail() throws Exception {
		System.out.println("***********scopeFail");
		String input = "class A {\n  def x:int;\n }\n print x;\n}";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		typeCheckIncorrectAST(program);
...
//	@Test
	/**
	 * TODO: Get test to work
	 * Cannot re-declare an int variable
	 * @throws Exception
	 */
	public void intRedeclarationFail() throws Exception {
		System.out.println("***********intRedeclarationFail");
		String input = "class A {\n def x:int;\n def x:int\n }";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		typeCheckIncorrectAST(program);
...
//	@Test
	/**
	 * TODO: Get test to work
	 * Cannot re-declare a string variable
	 * @throws Exception
	 */
	public void stringRedeclarationFail() throws Exception {
		System.out.println("***********stringRedeclarationFail");
		String input = "class A {\n def x:string;\n def x:string\n }";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		typeCheckIncorrectAST(program);
...
//	@Test
	/**
	 * TODO: Get test to work
	 * Cannot re-declare a boolean variable
	 * @throws Exception
	 */
	public void booleanRedeclarationFail() throws Exception {
		System.out.println("***********booleanRedeclarationFail");
		String input = "class A {\n def x:boolean;\n def x:boolean\n }";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
		typeCheckIncorrectAST(program);
...
//	@Test
	/**
	 * TODO: Get test to work
	 * Cannot re-declare variables of different types
	 * @throws Exception
	 */
	public void varRedeclarationFail() throws Exception {
		System.out.println("***********booleanRedeclarationFail");
		String input = "class A {\n def x:int;\n def x:boolean\n }";
		System.out.println(input);
		Program program = (Program) parseCorrectInput(input);
